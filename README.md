...
```sh
curl -o- https://raw.githubusercontent.com/ocariot/docker-swarm/1.3.0/install.sh | sudo bash
```

```sh
wget -qO- https://raw.githubusercontent.com/ocariot/docker-swarm/1.3.0/install.sh | sudo bash
```
